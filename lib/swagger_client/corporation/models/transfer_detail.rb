...
module SwaggerClient
  class TransferDetail
    ...
    attr_accessor :transfer_detail_fee
    ...
    attr_accessor :transfer_responses
    ...
    def self.swagger_types
      {
        ...
        :'transfer_responses' => :'Array<TransferResponse>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'transferDetailFee')
        self.transfer_detail_fee = attributes[:'transferDetailFee']
      end
      ...
      if attributes.has_key?(:'transferResponses')
        if (value = attributes[:'transferResponses']).is_a?(Array)
          self.transfer_responses = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@transfer_detail_fee.nil? && @transfer_detail_fee.to_s.length > 20
        invalid_properties.push('invalid value for "transfer_detail_fee", the character length must be smaller than or equal to 20.')
      end

      if !@transfer_detail_fee.nil? && @transfer_detail_fee.to_s.length < 1
        invalid_properties.push('invalid value for "transfer_detail_fee", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@transfer_detail_fee.nil? && @transfer_detail_fee.to_s.length > 20
      return false if !@transfer_detail_fee.nil? && @transfer_detail_fee.to_s.length < 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] transfer_detail_fee Value to be assigned
    def transfer_detail_fee=(transfer_detail_fee)
      if !transfer_detail_fee.nil? && transfer_detail_fee.to_s.length > 20
        fail ArgumentError, 'invalid value for "transfer_detail_fee", the character length must be smaller than or equal to 20.'
      end

      if !transfer_detail_fee.nil? && transfer_detail_fee.to_s.length < 1
        fail ArgumentError, 'invalid value for "transfer_detail_fee", the character length must be great than or equal to 1.'
      end

      @transfer_detail_fee = transfer_detail_fee
    end
    ...
    def hash
      [transfer_status, transfer_status_name, transfer_type_name, is_fee_free_use, is_fee_point_use, point_name, fee_later_payment_flg, transfer_detail_fee, total_debit_amount, transfer_applies, transfer_accepts, transfer_responses].hash
    end
