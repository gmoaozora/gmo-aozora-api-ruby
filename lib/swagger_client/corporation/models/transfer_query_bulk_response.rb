...
module SwaggerClient
  class TransferQueryBulkResponse
    ...
    def self.swagger_types
      {
        ...
        :'request_transfer_statuses' => :'Array<RequestTransferStatus>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'requestNextItemKey')
        self.request_next_item_key = attributes[:'requestNextItemKey']
      end

      if attributes.has_key?(:'requestTransferStatuses')
        if (value = attributes[:'requestTransferStatuses']).is_a?(Array)
          self.request_transfer_statuses = value
        end
      end

      if attributes.has_key?(:'requestTransferClass')
        self.request_transfer_class = attributes[:'requestTransferClass']
      end

      if attributes.has_key?(:'requestTransferTerm')
        self.request_transfer_term = attributes[:'requestTransferTerm']
      end
    ...
    def list_invalid_properties
      ...
      if !@request_next_item_key.nil? && @request_next_item_key.to_s.length > 24
        invalid_properties.push('invalid value for "request_next_item_key", the character length must be smaller than or equal to 24.')
      end

      if !@request_next_item_key.nil? && @request_next_item_key.to_s.length < 1
        invalid_properties.push('invalid value for "request_next_item_key", the character length must be great than or equal to 1.')
      end

      if !@request_transfer_class.nil? && @request_transfer_class.to_s.length > 1
        invalid_properties.push('invalid value for "request_transfer_class", the character length must be smaller than or equal to 1.')
      end

      if !@request_transfer_class.nil? && @request_transfer_class.to_s.length < 1
        invalid_properties.push('invalid value for "request_transfer_class", the character length must be great than or equal to 1.')
      end

      if !@request_transfer_term.nil? && @request_transfer_term.to_s.length > 1
        invalid_properties.push('invalid value for "request_transfer_term", the character length must be smaller than or equal to 1.')
      end

      if !@request_transfer_term.nil? && @request_transfer_term.to_s.length < 1
        invalid_properties.push('invalid value for "request_transfer_term", the character length must be great than or equal to 1.')
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] request_next_item_key Value to be assigned
    ...
    # Custom attribute writer method with validation
    # @param [Object] request_transfer_class Value to be assigned
    def request_transfer_class=(request_transfer_class)
      if !request_transfer_class.nil? && request_transfer_class.to_s.length > 1
        fail ArgumentError, 'invalid value for "request_transfer_class", the character length must be smaller than or equal to 1.'
      end

      if !request_transfer_class.nil? && request_transfer_class.to_s.length < 1
        fail ArgumentError, 'invalid value for "request_transfer_class", the character length must be great than or equal to 1.'
      end

      @request_transfer_class = request_transfer_class
    end

    # Custom attribute writer method with validation
    # @param [Object] request_transfer_term Value to be assigned
    def request_transfer_term=(request_transfer_term)
      if !request_transfer_term.nil? && request_transfer_term.to_s.length > 1
        fail ArgumentError, 'invalid value for "request_transfer_term", the character length must be smaller than or equal to 1.'
      end

      if !request_transfer_term.nil? && request_transfer_term.to_s.length < 1
        fail ArgumentError, 'invalid value for "request_transfer_term", the character length must be great than or equal to 1.'
      end

      @request_transfer_term = request_transfer_term
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          date_to == o.date_to &&
          request_next_item_key == o.request_next_item_key &&
          request_transfer_statuses == o.request_transfer_statuses &&
          request_transfer_class == o.request_transfer_class &&
          request_transfer_term == o.request_transfer_term &&
          has_next == o.has_next &&
    ...
    def hash
      [date_from, date_to, request_next_item_key, request_transfer_statuses, request_transfer_class, request_transfer_term, has_next, next_item_key].hash
    end
