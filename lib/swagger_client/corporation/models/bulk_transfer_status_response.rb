...
module SwaggerClient
  class BulkTransferStatusResponse
    ...
    attr_accessor :detail_info_necessity

    # 総合振込明細情報取得対象キー 半角数字 リクエストしたときと同じ内容 該当する情報が無い場合は項目自体を設定しません 
    attr_accessor :bulktransfer_item_key
    ...
    attr_accessor :detail_info_result
    ...
    attr_accessor :bulk_transfer_details
    ...
    def self.swagger_types
      {
        ...
        :'detail_info_necessity' => :'BOOLEAN',
        :'bulktransfer_item_key' => :'String',
        :'base_date' => :'String',
        :'base_time' => :'String',
        :'count' => :'String',
        :'detail_info_result' => :'BOOLEAN',
        :'transfer_query_bulk_responses' => :'Array<TransferQueryBulkResponse>',
        :'bulk_transfer_details' => :'Array<BulkTransferDetail>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'detailInfoNecessity')
        self.detail_info_necessity = attributes[:'detailInfoNecessity']
      end

      if attributes.has_key?(:'bulktransferItemKey')
        self.bulktransfer_item_key = attributes[:'bulktransferItemKey']
      end
      ...
      if attributes.has_key?(:'detailInfoResult')
        self.detail_info_result = attributes[:'detailInfoResult']
      end
      ...
      if attributes.has_key?(:'bulkTransferDetails')
        if (value = attributes[:'bulkTransferDetails']).is_a?(Array)
          self.bulk_transfer_details = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@bulktransfer_item_key.nil? && @bulktransfer_item_key.to_s.length > 6
        invalid_properties.push('invalid value for "bulktransfer_item_key", the character length must be smaller than or equal to 6.')
      end

      if !@bulktransfer_item_key.nil? && @bulktransfer_item_key.to_s.length < 1
        invalid_properties.push('invalid value for "bulktransfer_item_key", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @acceptance_key_class.to_s.length < 1
      return false if !@bulktransfer_item_key.nil? && @bulktransfer_item_key.to_s.length > 6
      return false if !@bulktransfer_item_key.nil? && @bulktransfer_item_key.to_s.length < 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] bulktransfer_item_key Value to be assigned
    def bulktransfer_item_key=(bulktransfer_item_key)
      if !bulktransfer_item_key.nil? && bulktransfer_item_key.to_s.length > 6
        fail ArgumentError, 'invalid value for "bulktransfer_item_key", the character length must be smaller than or equal to 6.'
      end

      if !bulktransfer_item_key.nil? && bulktransfer_item_key.to_s.length < 1
        fail ArgumentError, 'invalid value for "bulktransfer_item_key", the character length must be great than or equal to 1.'
      end

      @bulktransfer_item_key = bulktransfer_item_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          detail_info_necessity == o.detail_info_necessity &&
          bulktransfer_item_key == o.bulktransfer_item_key &&
          base_date == o.base_date &&
          base_time == o.base_time &&
          count == o.count &&
          detail_info_result == o.detail_info_result &&
          transfer_query_bulk_responses == o.transfer_query_bulk_responses &&
          bulk_transfer_details == o.bulk_transfer_details
    end
    ...
    def hash
      [acceptance_key_class, detail_info_necessity, bulktransfer_item_key, base_date, base_time, count, detail_info_result, transfer_query_bulk_responses, bulk_transfer_details].hash
    end
