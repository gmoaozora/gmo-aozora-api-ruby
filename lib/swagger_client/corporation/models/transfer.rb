...
module SwaggerClient
  class Transfer
    # 明細番号 半角数字 重複/0はエラー　1～99の範囲で１からの連番とします 1件のみの場合は省略可（項目自体の設定が不要です） 
    ...
    def hash
      [item_id, transfer_amount, edi_info, beneficiary_bank_code, beneficiary_bank_name, beneficiary_branch_code, beneficiary_branch_name, account_type_code, account_number, beneficiary_name].hash
    end
