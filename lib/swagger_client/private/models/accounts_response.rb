...
module SwaggerClient
  class AccountsResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'spAccounts')
        if (value = attributes[:'spAccounts']).is_a?(Array)
          self.sp_accounts = value
        end
      end
    end
    ...
    def hash
      [base_date, base_time, accounts, sp_accounts].hash
    end
