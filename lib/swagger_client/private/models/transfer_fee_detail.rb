...
module SwaggerClient
  class TransferFeeDetail
    ...
    def valid?
      ...
      return false if @transfer_fee.to_s.length > 20
      return false if @transfer_fee.to_s.length < 1
      true
    end
    ...
    def transfer_fee=(transfer_fee)
      if transfer_fee.nil?
        fail ArgumentError, 'transfer_fee cannot be nil'
      end
