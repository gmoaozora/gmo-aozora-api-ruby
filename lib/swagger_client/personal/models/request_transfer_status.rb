...
module SwaggerClient
  class RequestTransferStatus
    ...
    attr_accessor :request_transfer_status

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'request_transfer_status' => :'requestTransferStatus'
      }
    end
    ...
    def self.swagger_types
      {
        :'request_transfer_status' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'requestTransferStatus')
        self.request_transfer_status = attributes[:'requestTransferStatus']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@request_transfer_status.nil? && @request_transfer_status.to_s.length > 3
        invalid_properties.push('invalid value for "request_transfer_status", the character length must be smaller than or equal to 3.')
      end

      if !@request_transfer_status.nil? && @request_transfer_status.to_s.length < 1
        invalid_properties.push('invalid value for "request_transfer_status", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      return false if !@request_transfer_status.nil? && @request_transfer_status.to_s.length > 3
      return false if !@request_transfer_status.nil? && @request_transfer_status.to_s.length < 1
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] request_transfer_status Value to be assigned
    def request_transfer_status=(request_transfer_status)
      if !request_transfer_status.nil? && request_transfer_status.to_s.length > 3
        fail ArgumentError, 'invalid value for "request_transfer_status", the character length must be smaller than or equal to 3.'
      end

      if !request_transfer_status.nil? && request_transfer_status.to_s.length < 1
        fail ArgumentError, 'invalid value for "request_transfer_status", the character length must be great than or equal to 1.'
      end

      @request_transfer_status = request_transfer_status
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          request_transfer_status == o.request_transfer_status
    end
