...
module SwaggerClient
  class DepositTransactionsResponse
    ...
    attr_accessor :payment_arrivals
    ...
    def self.swagger_types
      {
        ...
        :'count' => :'String',
        :'payment_arrivals' => :'Array<PaymentArrival>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'paymentArrivals')
        if (value = attributes[:'paymentArrivals']).is_a?(Array)
          self.payment_arrivals = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          count == o.count &&
          payment_arrivals == o.payment_arrivals
    end
    ...
    def hash
      [account_id, date_from, date_to, base_date, base_time, has_next, next_item_key, count, payment_arrivals].hash
    end
