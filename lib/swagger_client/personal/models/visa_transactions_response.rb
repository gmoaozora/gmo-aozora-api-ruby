...
module SwaggerClient
  class VisaTransactionsResponse
    ...
    attr_accessor :visa_transactions
    ...
    def self.swagger_types
      {
        ...
        :'count' => :'String',
        :'visa_transactions' => :'Array<VisaTransaction>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'visaTransactions')
        if (value = attributes[:'visaTransactions']).is_a?(Array)
          self.visa_transactions = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          count == o.count &&
          visa_transactions == o.visa_transactions
    end
    ...
    def hash
      [account_id, date_from, date_to, base_date, base_time, has_next, next_item_key, count, visa_transactions].hash
    end
