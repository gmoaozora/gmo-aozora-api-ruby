...
module SwaggerClient
  class BulkTransferRequest
    ...
    attr_accessor :transfer_data_name
    ...
    def self.swagger_types
      {
        ...
        :'bulk_transfers' => :'Array<BulkTransfer>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'transferDataName')
        self.transfer_data_name = attributes[:'transferDataName']
      end
      ...
      if attributes.has_key?(:'bulkTransfers')
        if (value = attributes[:'bulkTransfers']).is_a?(Array)
          self.bulk_transfers = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@transfer_data_name.nil? && @transfer_data_name.to_s.length > 10
        invalid_properties.push('invalid value for "transfer_data_name", the character length must be smaller than or equal to 10.')
      end

      if !@transfer_data_name.nil? && @transfer_data_name.to_s.length < 1
        invalid_properties.push('invalid value for "transfer_data_name", the character length must be great than or equal to 1.')
      end
      ...
      if @bulk_transfers.nil?
        invalid_properties.push('invalid value for "bulk_transfers", bulk_transfers cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if !@transfer_date_holiday_code.nil? && @transfer_date_holiday_code.to_s.length < 1
      return false if !@transfer_data_name.nil? && @transfer_data_name.to_s.length > 10
      return false if !@transfer_data_name.nil? && @transfer_data_name.to_s.length < 1
      return false if @total_count.nil?
      return false if @total_count.to_s.length > 6
      return false if @total_count.to_s.length < 1
      return false if @total_amount.nil?
      return false if @total_amount.to_s.length > 20
      return false if @total_amount.to_s.length < 1
      ...
      return false if @bulk_transfers.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] transfer_data_name Value to be assigned
    def transfer_data_name=(transfer_data_name)
      if !transfer_data_name.nil? && transfer_data_name.to_s.length > 10
        fail ArgumentError, 'invalid value for "transfer_data_name", the character length must be smaller than or equal to 10.'
      end

      if !transfer_data_name.nil? && transfer_data_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "transfer_data_name", the character length must be great than or equal to 1.'
      end

      @transfer_data_name = transfer_data_name
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transfer_data_name == o.transfer_data_name &&
          total_count == o.total_count &&
          total_amount == o.total_amount &&
          apply_comment == o.apply_comment &&
          bulk_transfers == o.bulk_transfers
    end
    ...
    def hash
      [account_id, remitter_name, transfer_designated_date, transfer_date_holiday_code, transfer_data_name, total_count, total_amount, apply_comment, bulk_transfers].hash
    end
