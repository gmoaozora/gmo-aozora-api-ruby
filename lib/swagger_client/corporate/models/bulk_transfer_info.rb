...
module SwaggerClient
  class BulkTransferInfo
    ...
    def hash
      [item_id, beneficiary_bank_code, beneficiary_bank_name, beneficiary_branch_code, beneficiary_branch_name, clearing_house_name, account_type_code, account_number, beneficiary_name, transfer_amount, new_code, edi_info, transfer_designated_type, identification, transfer_detail_responses, unable_detail_infos].hash
    end
