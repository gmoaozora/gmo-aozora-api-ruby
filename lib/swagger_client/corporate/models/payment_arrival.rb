...
module SwaggerClient
  class PaymentArrival
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'applicantName')
        self.applicant_name = attributes[:'applicantName']
      end
    ...
    def list_invalid_properties
      ...
      if !@applicant_name.nil? && @applicant_name.to_s.length > 48
        invalid_properties.push('invalid value for "applicant_name", the character length must be smaller than or equal to 48.')
      end

      if !@applicant_name.nil? && @applicant_name.to_s.length < 1
        invalid_properties.push('invalid value for "applicant_name", the character length must be great than or equal to 1.')
      end

      if !@payment_bank_name.nil? && @payment_bank_name.to_s.length > 30
        invalid_properties.push('invalid value for "payment_bank_name", the character length must be smaller than or equal to 30.')
      end

      if !@payment_bank_name.nil? && @payment_bank_name.to_s.length < 1
        invalid_properties.push('invalid value for "payment_bank_name", the character length must be great than or equal to 1.')
      end

      if !@payment_branch_name.nil? && @payment_branch_name.to_s.length > 15
        invalid_properties.push('invalid value for "payment_branch_name", the character length must be smaller than or equal to 15.')
      end

      if !@payment_branch_name.nil? && @payment_branch_name.to_s.length < 1
    ...
    def valid?
      ...
      return false if !@applicant_name.nil? && @applicant_name.to_s.length > 48
      return false if !@applicant_name.nil? && @applicant_name.to_s.length < 1
      return false if !@payment_bank_name.nil? && @payment_bank_name.to_s.length > 30
      return false if !@payment_bank_name.nil? && @payment_bank_name.to_s.length < 1
      return false if !@payment_branch_name.nil? && @payment_branch_name.to_s.length > 15
      return false if !@payment_branch_name.nil? && @payment_branch_name.to_s.length < 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] applicant_name Value to be assigned
    def applicant_name=(applicant_name)
      if !applicant_name.nil? && applicant_name.to_s.length > 48
        fail ArgumentError, 'invalid value for "applicant_name", the character length must be smaller than or equal to 48.'
      end

      if !applicant_name.nil? && applicant_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "applicant_name", the character length must be great than or equal to 1.'
      end
    ...
    def hash
      [transaction_date, value_date, transaction_type, remarks, amount, applicant_name, payment_bank_name, payment_branch_name, edi_info, item_key].hash
    end
